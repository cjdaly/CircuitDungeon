// deep_backplate_6mm.scad — Chapter 8 / cd-bp3.6
// The custom backplate with a DEEPER interior for a bigger battery.
// This is the 6mm-extra-depth variant; see deep_backplate_20mm.scad for the
// deeper one. Both share this file's structure — only `extra_depth` differs.
//
...
// axis (flat faces -Y). Shared with button_extender_6mm.scad so bore and rod mate.
...
// button_extender_6mm.scad sets as_include_deep=true to reuse the params + d2d()
