// button_extender_6mm.scad — Chapter 8 / cd-bp3.6
// Printed BOOT/RESET push-rods for deep_backplate_6mm.scad's poke-tubes.
//
...
as_include_deep = true;   // deep_backplate_6mm.scad sets the custom/stock guards
include <deep_backplate_6mm.scad>
